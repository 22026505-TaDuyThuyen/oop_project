...
public final class GsonBuilder {
   ...
   * class. See the documentation in {@link SimpleDateFormat} for more information on
   ...
   * DateFormat} class. See the documentation in {@link DateFormat} for more information
